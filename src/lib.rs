...
#[derive(Debug)]
pub struct ViewPanelProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ViewPanelProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ViewPanel processing");
    
    let mut processor = ViewPanelProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ViewPanelProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ViewPanelProcessor::new(false);
